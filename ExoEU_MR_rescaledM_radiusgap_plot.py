...
MR_plot.prefix_output_name = './plots/ExoEU_MR_rescaledM_radius'
...
#MR_plot.prefix_output_name = './plots/large_ExoEU_MR_rescaledM_radius'
...
#MR_plot.font_USP_name = 14
#MR_plot.font_Solar_name =14
#MR_plot.prefix_output_name = './plots/giant_ExoEU_MR_rescaledM_radius'

#combination 3
#MR_plot.plot_size = [9.6,8]
#MR_plot.prefix_output_name = './plots/plot_ExoEU_MR_rescaledM_radius'
...
MR_plot.radius_label_position = ['left', 'bottom']
