...
fileout = open('veusz_Pmass20.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
...
fileout = open('veusz_Pmass25.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass40.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass60.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass80.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass20_ttv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass25_ttv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass40_ttv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass60_ttv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass80_ttv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins ttv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, ttv in \
...
fileout = open('veusz_Pmass20_nottv.dat','w')
...
fileout = open('veusz_Pmass25_nottv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins nottv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, nottv in \
...
fileout = open('veusz_Pmass40_nottv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins nottv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, nottv in \
...
fileout = open('veusz_Pmass60_nottv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins nottv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, nottv in \
...
fileout = open('veusz_Pmass80_nottv.dat','w')
fileout.write('descriptor name p m,+,- r,+,- d,+,- ins nottv\n')
for nm, p, m, mp, mm, r, rp, rm, d, dp, dm, ins, nottv in \
